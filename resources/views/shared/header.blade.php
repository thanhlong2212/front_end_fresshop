        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{url('/trangchu')}}"><img src="{{asset('/front-end/images/logo.png')}}" class="logo" alt=""></a>
                </div>
                <!-- End Header Navigation -->
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="{{url('/trangchu')}}">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{url('/about_us')}}">About Us</a></li>
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">SHOP</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{url('/sidebar_shop')}}">Sidebar Shop</a></li>
                                <li><a href="{{url('/shop_detail')}}">Shop Detail</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{url('/contacus')}}">Contact Us</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
