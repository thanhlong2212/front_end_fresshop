            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{asset('front-end/images/img-1.jpg')}}" alt="" />
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{asset('front-end/images/img-2.jpg')}}" alt="" />
                            <div class="team-content">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{asset('front-end/images/img-3.jpg')}}" alt="" />
                            <div class="team-content">
